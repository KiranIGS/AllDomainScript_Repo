...
import com.business.demoprojects.BaseClass;
...
import static com.utility.Utilities.RandomNumberGenerator;
...
//	final static Logger logger = Logger.getLogger("rootLogger");
    ...
    public static void initDriver() {
        if (getPlatform().equals("Web")) {
           wait = new WebDriverWait(getWebDriver(), Duration.ofMillis(600));
            ...
            wait = new WebDriverWait(DriverManager.getAppiumDriver(), Duration.ofMillis(600));
...
//			e.printStackTrace();
     ...
     * @return true, if successful
     */
    public static boolean verifyElementNotPresent(By byLocator, Duration iTimeOut) {
        try {
     ...
     */
    public static boolean waitforelementtoappear(By locator, Duration time) {
    ...
    public static boolean verifyElementExist(By byLocator, String str) throws Exception {
        ...
        try {
            if (getPlatform().equalsIgnoreCase("web")) {
                element = getWebDriver().findElement(byLocator);
                explicitWaitVisibility(byLocator, Duration.ofSeconds(20));
            } else {
                element = DriverManager.getAppiumDriver().findElement(byLocator);
                explicitWaitVisibility(byLocator,Duration.ofSeconds(20) );
            }
...
//    }
    ...
    public static boolean verifyElementNotPresentForWeb(By byLocator, Duration iTimeOut) {
        try {
...
//			logger.error(e);
	...
	public String OTPNotification() throws Exception {
		...
		Back(1);
		((SupportsContextSwitching) getDriver()).context("WEBVIEW_1");
		return Otp;
	}
    ...
    public static void hideKeyboard() {
        try {
            if (platform.equalsIgnoreCase("Android") || platform.equalsIgnoreCase("BrowserStack")
                ...
                ((HidesKeyboard) DriverManager.getAppiumDriver()).hideKeyboard();
            } else {
...
//			logger.error(e);
    ...
    public void GetAndVerifyOrientation(String Value) throws Exception {
        ScreenOrientation orientation = ((SupportsRotation) getDriver()).getOrientation();
...
//			softAssert.assertAll();
    ...
    public void closeAndroidApp() {
        try {
            ((SupportsLegacyAppManagement) getDriver()).resetApp();
...
//====================================================================================================================================
	 ...
	 * @throws Exception
	 */
	public static void explicitWaitVisibility(By element, Duration i) throws Exception {
		try{
        if (getPlatform().equalsIgnoreCase("web")) {
			WebDriverWait wait = new WebDriverWait(getWebDriver(), i);
			wait.until(ExpectedConditions.visibilityOf(findElement(element)));
		} else {
			WebDriverWait wait = new WebDriverWait(DriverManager.getAppiumDriver(), i);
	...
	public static void explicitWaitVisible(By byLocator, Duration time) throws Exception {
	...
	public static void selectByVisibleTextFromDD(By element, String value) throws Exception {
		explicitWaitVisibility(element, Duration.ofSeconds(20));
...
//			logger.error(e);
	 ...
	 * @throws Exception
	 */
	public static boolean waitForElementPresence(By locator, Duration seconds, String message) throws Exception {
		try {
			//	String platform = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getSuite().getName();
			if (platform.equalsIgnoreCase("web")) {
	 ...
	 * @throws Exception
	 */
	public static boolean waitForElementVisible(By locator, Duration seconds, String message) throws Exception {
		try {
			WebDriverWait w = new WebDriverWait(DriverManager.getDriver(), seconds);
	...
	public static void waitUntilElementVisible_NoCustomMessage(By by) {
		...
		try {
			...
			if (platform.equalsIgnoreCase("Android") || platform.equalsIgnoreCase("BrowserStack") || platform.equalsIgnoreCase("IOSBrowserStack")) {
				WebDriverWait wait = new WebDriverWait(DriverManager.getAppiumDriver(), Duration.ofSeconds(20));
				wait.until(ExpectedConditions.visibilityOfElementLocated(by));
			}
	 ...
	 * @throws Exception
	 */
	public static boolean waitForElementInVisible(By locator, Duration seconds, String message) throws Exception {
		try {
			WebDriverWait w = new WebDriverWait(DriverManager.getDriver(), seconds);
	...
	public static void Swipe(String direction, int count) {
		touchAction = new TouchAction((PerformsTouchActions) DriverManager.getAppiumDriver());
		String dire = direction;
		try {
			if (dire.equalsIgnoreCase("LEFT")) {
...
//	}
	...
	public  static void switchPlatformToAndroid() throws InterruptedException {
		waitTime(6000);
		...
		System.out.println(getPlatform());		
	    new DriverInstance("MLWALLET", deviceName, portNo);
		initDriver();
		}
...
//		}
	...
	public static int tapOnFirstSuggestion(By locator) throws Exception {
		...
		TouchAction ta = new TouchAction((PerformsTouchActions) DriverManager.getAppiumDriver());
...
//	}
	...
	public static void SwipeBanner(By byLocator, String direction, int k) throws Exception {
		TouchAction action = new TouchAction((PerformsTouchActions) DriverManager.getAppiumDriver());
		waitTime(1000);
		WebElement ele = DriverManager.getAppiumDriver().findElement(byLocator);
		Dimension size = DriverManager.getAppiumDriver().manage().window().getSize();
    ...
    public static void tapUsingCoordinates(int x, int y) throws Exception {
        TouchAction t = new TouchAction((PerformsTouchActions) DriverManager.getAppiumDriver());
        try {
...
//		ExtentReporter.extentLoggerPass("", "Typed the value " + value + " into " + FieldName);
    ...
    public static void reopenGCash() {
        ((InteractsWithApps) DriverManager.getAppiumDriver()).activateApp("com.globe.gcash.android.uat.tokyo");
    }

    public static void closeMobileChromeApp() {
        DriverManager.getAppiumDriver().close();
    }
        ...
        for (int i = 0; i <= 4; i++) {
            ...
            try {
                ...
                if (elementFound == false) {
					...
					((PerformsTouchActions) DriverManager.getAppiumDriver()).performTouchAction(action);
				}
				elementFound = false;
			}
...
//	}
	...
	public static void DoubleClickWeb(By locator, String OptionName) {
		try {
			explicitWaitVisibleWeb(locator, Duration.ofSeconds(20));
	...
	public static void explicitWaitVisibleWeb(By byLocator, Duration time) throws Exception {
...
//	}
    ...
    public  static void assertNotEquals(String actual, String expected) throws Exception {
        ...
        public static String  RandomNumberGenerator(int number) {
            ...
            // Generate a random number between 0 and 29 (inclusive)
    ...
    public static boolean compareValue(String actual, String expected) throws Exception
	{
		try
		{
			if(actual.equalsIgnoreCase(expected))
			{
				logger.info("The actual '"+actual+"' and expected '"+expected+"' values are matching");
				ExtentReporter.extentLoggerPass("","The actual '"+actual+"' and expected '"+expected+"' values are matching");
			return true;
			}
			else
			{
				logger.info("The actual '"+actual+"' and expected '"+expected+"' values are not matching");
				ExtentReporter.extentLoggerWarning("","The actual '"+actual+"' and expected '"+expected+"' values are not matching");
				return false;
			}
			
		}catch(Exception e)
		{
			logger.info("Exception in 'compareValue()' method "+e.getMessage());
			ExtentReporter.extentLoggerWarning("Exception","Exception in 'compareValue()' method "+e.getMessage());
			return false;
		}
	}
    /********************************************************************
     ...
     * *******************************************************************
     */
    public static void selectDropdown(By objLocator, String selectionType, String input) throws Exception {
    	String val;
    	Select osel=null;
    	try {
    		osel=new Select(getWebDriver().findElement(objLocator));
    	switch(selectionType)
    	{
    		case  "visibleText" :		   
    			   osel.selectByVisibleText(input);
    			   val=osel.getFirstSelectedOption().getText();
    			   logger.info("Dropdown By visible text selected value "+val);
       			   ExtentReporter.extentLoggerPass("Dropdown", "Dropdown By visible text selected value "+"'"+val+"'");
    			   break;
    			   
    		case   "selectByIndex":
    			   osel.selectByIndex(Integer.parseInt(input));
    			   val=osel.getFirstSelectedOption().getText();
    			   logger.info("Dropdown By index selected value "+val);
       			   ExtentReporter.extentLoggerPass("Dropdown", "Dropdown By index selected value "+"'"+val+"'");
    			   break;
    		
    		case  "selectByValue":
    			  osel.selectByValue(input);
    			  val=osel.getFirstSelectedOption().getText();
    			  logger.info("Dropdown By value selected value "+val);
      			  ExtentReporter.extentLoggerPass("Dropdown", "Dropdown By value selected value "+"'"+val+"'");
    			  break;
    			  
    		default:
    			logger.info("Invalid Dropdown selector choosen");
    			ExtentReporter.extentLoggerWarning("DropDown", "Invalid Dropdown selector choosen");			
    	}  	
    	
    	}catch(Exception e)
    	{
    		logger.info("DropDown Method Failed to select the object By "+""+selectionType+""+" for the object "+String.valueOf(objLocator));
    		ExtentReporter.extentLoggerFail("fail", "DropDown Method Failed to select the object By "+""+selectionType+""+" for the object "+String.valueOf(objLocator));
    	}
    }
    
//    public static void main(String[] args) {
//    	String date="202"+RandomNumberGenerator(9);
